...
namespace Semana_8_Proyecto_Login {
    ...
    public partial class sistemaDataSet : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuariosRow AddusuariosRow(string usuario, string password, int level) {
        ...
        public partial class usuariosRow : global::System.Data.DataRow {
            ...
            public int level {
                get {
                    try {
                        return ((int)(this[this.tableusuarios.levelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IslevelNull() {
                return this.IsNull(this.tableusuarios.levelColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetlevelNull() {
                this[this.tableusuarios.levelColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Semana_8_Proyecto_Login.sistemaDataSetTableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `usuarios` WHERE ((`Id` = ?) AND ((? = 1 AND `usuario` IS NULL) OR (`" +
                "usuario` = ?)) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `usuarios` (`usuario`, `password`, `level`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `usuarios` SET `usuario` = ?, `password` = ?, `level` = ? WHERE ((`Id` = ?" +
                ") AND ((? = 1 AND `usuario` IS NULL) OR (`usuario` = ?)) AND ((? = 1 AND `passwo" +
                "rd` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `level` IS NULL) OR (`level` =" +
                " ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Semana_8_Proyecto_Login.Properties.Settings.Default.sistemaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, usuario, [password], [level] FROM usuarios";
        ...
        public virtual int Fill(sistemaDataSet.usuariosDataTable dataTable) {
        ...
        public virtual sistemaDataSet.usuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            sistemaDataSet.usuariosDataTable dataTable = new sistemaDataSet.usuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(sistemaDataSet.usuariosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_usuario, string Original_password, global::System.Nullable<int> Original_level) {
        ...
        public virtual int Insert(string usuario, string password, global::System.Nullable<int> level) {
            if ((usuario == null)) {
        ...
        public virtual int Update(string usuario, string password, global::System.Nullable<int> level, int Original_Id, string Original_usuario, string Original_password, global::System.Nullable<int> Original_level) {
            if ((usuario == null)) {
